...
void main() {
  group('migration safety', () {
    test('upgrades schema v8 to v9 with legacy backups and collection cleanup', () async {
      ...
      await database.customSelect('SELECT COUNT(*) AS total FROM collections').get();
